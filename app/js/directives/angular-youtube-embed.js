...
angular.module('app').service ('youtubeEmbedUtils', ['$window', '$rootScope', function ($window, $rootScope) {
    var Service = {};
        ...
        link: function (scope, element, attrs) {
            ...
            var stopWatchingReady = scope.$watch(
                function () {
                    ...
                    return scope.utils.ready && (typeof scope.videoUrl !== 'undefined' ||  typeof scope.videoId !== 'undefined');
                },
                function (ready) {
                    if (ready) {
                        stopWatchingReady();
